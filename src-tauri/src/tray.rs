...
mod tests {
    use super::{
        ...
        format_today_usage_overview_labels, format_today_usage_summary, format_usage_suffix,
        format_usd_badge, format_usd_short, provider_uses_official_subscription, tray_usage_source,
        TrayTexts, TrayUsageSource, TRAY_ID, TRAY_SECTIONS,
    };
    use crate::app_config::AppType;
